...
pub const GEOS_VERSION_MINOR: u32 = 15;
pub const GEOS_CAPI_VERSION_MAJOR: u32 = 1;
pub const GEOS_CAPI_VERSION_MINOR: u32 = 21;
pub const GEOS_CAPI_VERSION_PATCH: u32 = 1;
...
>;
pub type GEOSProgressCallback = ::std::option::Option<
    unsafe extern "C" fn(
        progressRatio: libc::c_double,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GEOSCoverageCleanParams_t {
    _unused: [u8; 0],
}
pub type GEOSCoverageCleanParams = GEOSCoverageCleanParams_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GEOSClusterInfo_t {
    _unused: [u8; 0],
}
pub type GEOSClusterInfo = GEOSClusterInfo_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GEOSCurveToLineParams_t {
    _unused: [u8; 0],
}
pub type GEOSCurveToLineParams = GEOSCurveToLineParams_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GEOSLineToCurveParams_t {
    _unused: [u8; 0],
}
pub type GEOSLineToCurveParams = GEOSLineToCurveParams_t;
...
pub const GEOSOverlapMerge_GEOS_MERGE_LONGEST_BORDER: GEOSOverlapMerge = 0;
pub const GEOSOverlapMerge_GEOS_MERGE_MAX_AREA: GEOSOverlapMerge = 1;
pub const GEOSOverlapMerge_GEOS_MERGE_MIN_AREA: GEOSOverlapMerge = 2;
pub const GEOSOverlapMerge_GEOS_MERGE_MIN_INDEX: GEOSOverlapMerge = 3;
pub type GEOSOverlapMerge = libc::c_uint;
...
>;
pub type GEOSTransformXYZCallback = ::std::option::Option<
    unsafe extern "C" fn(
        x: *mut libc::c_double,
        y: *mut libc::c_double,
        z: *mut libc::c_double,
...
pub type GEOSContextInterruptCallback =
...
extern "C" {
    pub fn GEOSContext_setInterruptCallback_r(
        extHandle: GEOSContextHandle_t,
        cb: GEOSContextInterruptCallback,
        userData: *mut libc::c_void,
...
extern "C" {
    pub fn GEOSContext_setProgressCallback_r(
        extHandle: GEOSContextHandle_t,
        cb: GEOSProgressCallback,
        userData: *mut libc::c_void,
...
extern "C" {
    pub fn GEOSContext_setCurveToLineParams_r(
        extHandle: GEOSContextHandle_t,
        params: *const GEOSCurveToLineParams,
    );
}
extern "C" {
    pub fn GEOSContext_setLineToCurveParams_r(
        extHandle: GEOSContextHandle_t,
        params: *const GEOSLineToCurveParams,
    );
}
extern "C" {
...
extern "C" {
    pub fn GEOSCoordSeq_hasZ_r(
        handle: GEOSContextHandle_t,
        s: *mut GEOSCoordSequence,
    ) -> libc::c_char;
}
extern "C" {
    pub fn GEOSCoordSeq_hasM_r(
        handle: GEOSContextHandle_t,
        s: *mut GEOSCoordSequence,
    ) -> libc::c_char;
}
...
extern "C" {
    pub fn GEOSCoverageCleanParams_create_r(
        extHandle: GEOSContextHandle_t,
    ) -> *mut GEOSCoverageCleanParams;
}
extern "C" {
    pub fn GEOSCoverageCleanParams_destroy_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSCoverageCleanParams,
    );
}
extern "C" {
    pub fn GEOSCoverageCleanParams_setSnappingDistance_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSCoverageCleanParams,
        snappingDistance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCoverageCleanParams_setGapMaximumWidth_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSCoverageCleanParams,
        gapMaximumWidth: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCoverageCleanParams_setOverlapMergeStrategy_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSCoverageCleanParams,
        overlapMergeStrategy: libc::c_int,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCoverageCleanWithParams_r(
        extHandle: GEOSContextHandle_t,
        input: *const GEOSGeometry,
        params: *const GEOSCoverageCleanParams,
    ) -> *mut GEOSGeometry;
}
extern "C" {
    pub fn GEOSCoverageClean_r(
        extHandle: GEOSContextHandle_t,
        input: *const GEOSGeometry,
    ) -> *mut GEOSGeometry;
}
...
extern "C" {
    pub fn GEOSSubdivideByGrid_r(
        ...
        nx: libc::c_uint,
        ny: libc::c_uint,
        includeExterior: libc::c_int,
    ) -> *mut GEOSGeometry;
}
extern "C" {
    pub fn GEOSGridIntersectionFractions_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
        xmin: libc::c_double,
        ymin: libc::c_double,
...
extern "C" {
    pub fn GEOSMinimumSpanningTree_r(
        handle: GEOSContextHandle_t,
        geoms: *const *const GEOSGeometry,
        ngeoms: libc::c_uint,
    ) -> *mut usize;
...
extern "C" {
    pub fn GEOSisSimpleDetail_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
        findAllLocations: libc::c_int,
...
extern "C" {
    pub fn GEOSGetNumCurves_r(handle: GEOSContextHandle_t, g: *const GEOSGeometry) -> libc::c_int;
}
extern "C" {
    pub fn GEOSGetCurveN_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
        n: libc::c_int,
    ) -> *const GEOSGeometry;
...
extern "C" {
    pub fn GEOSCurveToLineParams_setMaxStepDegrees_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSCurveToLineParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCurveToLineParams_setMaxDeviation_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSCurveToLineParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
...
extern "C" {
    pub fn GEOSLineToCurveParams_setRadiusTolerance_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSLineToCurveParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSLineToCurveParams_setMaxStepDegrees_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSLineToCurveParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
...
extern "C" {
    pub fn GEOSLineToCurveParams_setMaxAngleDifferenceDegrees_r(
        extHandle: GEOSContextHandle_t,
        params: *mut GEOSLineToCurveParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
...
extern "C" {
    pub fn GEOSHausdorffDistanceWithPoints_r(
        handle: GEOSContextHandle_t,
        g1: *const GEOSGeometry,
        g2: *const GEOSGeometry,
        dist: *mut libc::c_double,
        p1x: *mut libc::c_double,
        p1y: *mut libc::c_double,
        p2x: *mut libc::c_double,
        p2y: *mut libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn GEOSHausdorffDistanceDensifyWithPoints_r(
        handle: GEOSContextHandle_t,
        g1: *const GEOSGeometry,
        g2: *const GEOSGeometry,
        densifyFrac: libc::c_double,
...
extern "C" {
    pub fn GEOSGeom_transformXYZ_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
...
extern "C" {
    pub fn GEOSClusterDBSCAN_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
        eps: libc::c_double,
        minPoints: libc::c_uint,
    ) -> *mut GEOSClusterInfo;
}
extern "C" {
    pub fn GEOSClusterGeometryDistance_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
        d: libc::c_double,
    ) -> *mut GEOSClusterInfo;
...
extern "C" {
    pub fn GEOSClusterGeometryIntersects_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
    ) -> *mut GEOSClusterInfo;
}
extern "C" {
    pub fn GEOSClusterEnvelopeDistance_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
        d: libc::c_double,
    ) -> *mut GEOSClusterInfo;
...
extern "C" {
    pub fn GEOSClusterEnvelopeIntersects_r(
        handle: GEOSContextHandle_t,
        g: *const GEOSGeometry,
    ) -> *mut GEOSClusterInfo;
}
extern "C" {
    pub fn GEOSClusterInfo_getNumClusters_r(
        arg1: GEOSContextHandle_t,
        clusters: *const GEOSClusterInfo,
    ) -> usize;
}
extern "C" {
    pub fn GEOSClusterInfo_getClusterSize_r(
        arg1: GEOSContextHandle_t,
        clusters: *const GEOSClusterInfo,
        i: usize,
    ) -> usize;
...
extern "C" {
    pub fn GEOSClusterInfo_getClustersForInputs_r(
        arg1: GEOSContextHandle_t,
        clusters: *const GEOSClusterInfo,
    ) -> *mut usize;
}
extern "C" {
    pub fn GEOSClusterInfo_getInputsForClusterN_r(
        arg1: GEOSContextHandle_t,
        clusters: *const GEOSClusterInfo,
        i: usize,
    ) -> *const usize;
...
extern "C" {
    pub fn GEOSClusterInfo_destroy_r(arg1: GEOSContextHandle_t, info: *mut GEOSClusterInfo);
}
extern "C" {
...
extern "C" {
    pub fn GEOSGeoJSONWriter_setOutputDimension_r(
        handle: GEOSContextHandle_t,
        writer: *mut GEOSGeoJSONWriter,
        dim: libc::c_int,
    );
...
extern "C" {
    pub fn GEOSGeoJSONWriter_getOutputDimension_r(
        handle: GEOSContextHandle_t,
        writer: *mut GEOSGeoJSONWriter,
    ) -> libc::c_int;
}
...
extern "C" {
    pub fn GEOSCoordSeq_createWithDimensions(
        size: libc::c_uint,
        hasZ: libc::c_int,
        hasM: libc::c_int,
    ) -> *mut GEOSCoordSequence;
...
extern "C" {
    pub fn GEOSCoordSeq_hasZ(s: *mut GEOSCoordSequence) -> libc::c_char;
}
extern "C" {
    pub fn GEOSCoordSeq_hasM(s: *mut GEOSCoordSequence) -> libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn GEOSGetNumCurves(g: *const GEOSGeometry) -> libc::c_int;
}
extern "C" {
    pub fn GEOSGetCurveN(g: *const GEOSGeometry, n: libc::c_int) -> *const GEOSGeometry;
}
extern "C" {
...
extern "C" {
    pub fn GEOSisSimpleDetail(
        g: *const GEOSGeometry,
        findAllLocations: libc::c_int,
        locations: *mut *mut GEOSGeometry,
    ) -> libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn GEOSHausdorffDistanceWithPoints(
        g1: *const GEOSGeometry,
        g2: *const GEOSGeometry,
        dist: *mut libc::c_double,
        p1x: *mut libc::c_double,
...
extern "C" {
    pub fn GEOSHausdorffDistanceDensifyWithPoints(
        g1: *const GEOSGeometry,
        g2: *const GEOSGeometry,
        densifyFrac: libc::c_double,
        dist: *mut libc::c_double,
...
extern "C" {
    pub fn GEOSGridIntersectionFractions(
        g: *const GEOSGeometry,
        xmin: libc::c_double,
        ymin: libc::c_double,
        xmax: libc::c_double,
...
extern "C" {
    pub static GEOS_CLUSTER_NONE: usize;
}
extern "C" {
    pub fn GEOSClusterDBSCAN(
        g: *const GEOSGeometry,
        eps: libc::c_double,
        minPoints: libc::c_uint,
    ) -> *mut GEOSClusterInfo;
...
extern "C" {
    pub fn GEOSClusterGeometryDistance(
        g: *const GEOSGeometry,
        d: libc::c_double,
    ) -> *mut GEOSClusterInfo;
}
extern "C" {
    pub fn GEOSClusterGeometryIntersects(g: *const GEOSGeometry) -> *mut GEOSClusterInfo;
}
extern "C" {
    pub fn GEOSClusterEnvelopeDistance(
        g: *const GEOSGeometry,
        d: libc::c_double,
    ) -> *mut GEOSClusterInfo;
}
extern "C" {
    pub fn GEOSClusterEnvelopeIntersects(g: *const GEOSGeometry) -> *mut GEOSClusterInfo;
}
extern "C" {
    pub fn GEOSClusterInfo_getNumClusters(clusters: *const GEOSClusterInfo) -> usize;
}
extern "C" {
    pub fn GEOSClusterInfo_getClusterSize(clusters: *const GEOSClusterInfo, i: usize) -> usize;
}
extern "C" {
    pub fn GEOSClusterInfo_getClustersForInputs(clusters: *const GEOSClusterInfo) -> *mut usize;
}
extern "C" {
    pub fn GEOSClusterInfo_getInputsForClusterN(
        clusters: *const GEOSClusterInfo,
        i: usize,
    ) -> *const usize;
}
extern "C" {
    pub fn GEOSClusterInfo_destroy(clusters: *mut GEOSClusterInfo);
}
extern "C" {
    pub fn GEOSBuffer(
        g: *const GEOSGeometry,
...
extern "C" {
    pub fn GEOSCoverageEdges(
        input: *const GEOSGeometry,
        edgetype: libc::c_int,
    ) -> *mut GEOSGeometry;
}
extern "C" {
    pub fn GEOSCoverageCleanParams_create() -> *mut GEOSCoverageCleanParams;
}
extern "C" {
    pub fn GEOSCoverageCleanParams_destroy(params: *mut GEOSCoverageCleanParams);
}
extern "C" {
    pub fn GEOSCoverageCleanParams_setSnappingDistance(
        params: *mut GEOSCoverageCleanParams,
        snappingDistance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCoverageCleanParams_setGapMaximumWidth(
        params: *mut GEOSCoverageCleanParams,
        gapMaximumWidth: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCoverageCleanParams_setOverlapMergeStrategy(
        params: *mut GEOSCoverageCleanParams,
        overlapMergeStrategy: libc::c_int,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCoverageCleanWithParams(
        input: *const GEOSGeometry,
        params: *const GEOSCoverageCleanParams,
    ) -> *mut GEOSGeometry;
}
extern "C" {
    pub fn GEOSCoverageClean(input: *const GEOSGeometry) -> *mut GEOSGeometry;
}
extern "C" {
...
extern "C" {
    pub fn GEOSSplit(g: *const GEOSGeometry, edge: *const GEOSGeometry) -> *mut GEOSGeometry;
}
extern "C" {
...
extern "C" {
    pub fn GEOSMinimumSpanningTree(
        geoms: *const *const GEOSGeometry,
        ngeoms: libc::c_uint,
    ) -> *mut usize;
}
...
extern "C" {
    pub fn GEOSCurveToLine(
        g: *const GEOSGeometry,
        params: *const GEOSCurveToLineParams,
    ) -> *mut GEOSGeometry;
}
extern "C" {
    pub fn GEOSCurveToLineParams_create() -> *mut GEOSCurveToLineParams;
}
extern "C" {
    pub fn GEOSCurveToLineParams_destroy(params: *mut GEOSCurveToLineParams);
}
extern "C" {
    pub fn GEOSCurveToLineParams_setMaxStepDegrees(
        params: *mut GEOSCurveToLineParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSCurveToLineParams_setMaxDeviation(
        params: *mut GEOSCurveToLineParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSLineToCurve(
        g: *const GEOSGeometry,
        params: *const GEOSLineToCurveParams,
    ) -> *mut GEOSGeometry;
}
extern "C" {
    pub fn GEOSLineToCurveParams_create() -> *mut GEOSLineToCurveParams;
}
extern "C" {
    pub fn GEOSLineToCurveParams_destroy(params: *mut GEOSLineToCurveParams);
}
extern "C" {
    pub fn GEOSLineToCurveParams_setRadiusTolerance(
        params: *mut GEOSLineToCurveParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSLineToCurveParams_setMaxStepDegrees(
        params: *mut GEOSLineToCurveParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
}
extern "C" {
    pub fn GEOSLineToCurveParams_setMaxAngleDifferenceDegrees(
        params: *mut GEOSLineToCurveParams,
        tolerance: libc::c_double,
    ) -> libc::c_int;
}
...
extern "C" {
    pub fn GEOSGeoJSONWriter_setOutputDimension(writer: *mut GEOSGeoJSONWriter, dim: libc::c_int);
}
extern "C" {
    pub fn GEOSGeoJSONWriter_getOutputDimension(writer: *mut GEOSGeoJSONWriter) -> libc::c_int;
}
extern "C" {
