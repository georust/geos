...
pub const GEOS_VERSION_MINOR: u32 = 10;
pub const GEOS_VERSION_PATCH: u32 = 3;
pub const GEOS_VERSION: &[u8; 7usize] = b"3.10.3\0";
...
pub const GEOS_CAPI_VERSION: &[u8; 19usize] = b"3.10.3-CAPI-1.16.1\0";
...
extern "C" {
    #[doc = " Generates offset curve for linear geometry."]
    #[doc = " Only LineStrings accepted as input."]
...
extern "C" {
    ...
    #[doc = " specified tolerance. The obstacles are point and line geometries."]
    #[doc = " The LEC is the largest circle which  has its center in the convex hull of the"]
    #[doc = " obstacles (the boundary), and whose interior does not intersect with any obstacle."]
...
extern "C" {
    #[doc = " A \\ref GEOSPreparedGeometry is a wrapper around \\ref GEOSGeometry"]
    #[doc = " that adds in a spatial index on the edges of the geometry. This"]
    #[doc = " internal index allows spatial predicates to evaluate much faster,"]
    #[doc = " so for cases in which the same base geometry will be used over and"]
    #[doc = " over again for predicate tests, wrapping it in a \\ref GEOSPreparedGeometry"]
    #[doc = " is a best practice."]
    #[doc = ""]
    #[doc = " The caller retains ownership of the base geometry, and after"]
    #[doc = " processing is complete, must destroy **both** the prepared and the"]
...
extern "C" {
    #[doc = " Organize the sub-geometries, rings, and coordinate order"]
    #[doc = " of geometries, so that geometries that represent the same"]
    #[doc = " object can be easily compared. Starts rings from the same"]
    #[doc = " location, orients them in the same way, sorts geometry"]
    #[doc = " sub-components in the same way. Use before calling"]
    #[doc = " GEOSEqualsExact() to avoid false \"not equal\" results."]
    #[doc = " \\param g Input geometry"]
    #[doc = " \\return 0 on success or -1 on exception"]
    pub fn GEOSNormalize(g: *mut GEOSGeometry) -> libc::c_int;
}
extern "C" {
    #[doc = " Change the rounding precision on a geometry. This will"]
