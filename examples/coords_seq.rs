extern crate geos;
use geos::{version, GGeom, CoordSeq, _Point, _LineString, _LinearRing, _Polygon};
...
fn LineString(pts: &[(f64, f64)]) -> GGeom {
    let nb_pts = pts.len();
...
fn main() {
    ...
    assert_eq!(x, 1.3);
    assert_eq!(y, 2.4);
    let l_geom = LineString(&[(12.78, 78.08), (55.77, 77.55), (22.77, 88.99)]);
